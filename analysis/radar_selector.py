...
class RadarSelector:
    ...
    def __init__(self, params_dir: str = "default-site-params"):
        """
...
def main():
    ...
    selector = RadarSelector(params_dir="default-site-params")
    
    if not selector.radars:
        print("No radars found in default-site-params directory.")
        return
