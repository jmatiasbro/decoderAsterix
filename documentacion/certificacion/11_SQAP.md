...
| RNC-010 | C | Binarios (`.pcap`/`.duckdb`/`.venv`) versionados en el histórico git (integridad del árbol, gap C-3) | Abierta — requiere purga controlada (`git filter-repo`); detectada en auditoría AUD-C-01 ([doc 17 §3](17_registros_auditoria_SQA.md)) |
...
> y **RNC-010** (registrada en la auditoría SQA AUD-C-01) para la purga de binarios del histórico. Las
> auditorías de proceso/producto/transición están ejecutadas y registradas en el [doc 17](17_registros_auditoria_SQA.md).
