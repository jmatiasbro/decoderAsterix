...
from asterix_utils import read_fspec
    ...
    while offset < end_offset:
        ...
        for frn_index, is_present in enumerate(fspec):
            ...
            try:
                ...
                print(f"🚨 [CAT 01] Error de decodificación en FRN {frn}: {e}. Abortando plot.")
                offset = end_offset
                break
        ...
        if offset == offset_previo:
            print(f"🚨 [CAT 01] Bucle infinito evitado. Offset estancado en {offset}. Abortando bloque.")
            break
