...
# ============================================================
try:
    from decoders import cat001, cat021, cat048, cat062
except ImportError:
    # Fallback: si alguno no existe (ej. cat062), importamos los disponibles
    from decoders import cat001, cat021, cat048
    cat062 = None
...
class AsterixRouter:
    ...
    def procesar_paquete_udp(self, payload_bytes: bytes) -> List[Dict[str, Any]]:
        """
