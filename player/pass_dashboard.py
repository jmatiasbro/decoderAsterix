...
class PassDashboardDialog(QDialog):
    ...
    def _load_table_data(self):
        ...
        rows_def = [
            ...
            ("Detección Modo A — Válido", "pd_mode_a", "{:.2f}%"),
            ("Detección Modo A — Correcto", "mode_a_correct_pct", "{:.2f}%"),
            ("Detección Modo C — Válido", "pd_mode_c", "{:.2f}%"),
            ("Detección Modo C — Correcto", "mode_c_correct_pct", "{:.2f}%"),
            ("Tamaño Medio de Hueco (vueltas)", "gap_mean_size", "{:.2f}"),
            ("Huecos > 2 vueltas (%)", "gap_pct_gt2", "{:.2f}%"),
            ("Pérdidas en Huecos Grandes (%)", "gap_pct_misses_big", "{:.2f}%"),
