...
> **Config operativa desplegada** (`config/stca.json`, bajo SCM desde 2026-07-09): TMA 5.0 NM / 800 ft, Ruta 10.0 NM / 800 ft, `velocidad_min_kt = 0`, `lookahead_s = 120`. Los umbrales horizontales son **más conservadores** que los normativos por defecto. `velocidad_min_kt = 0` es **seguro** porque los parrots se excluyen por identidad (HLR-STCA-09), no por velocidad — así se protege el tráfico lento real (helicóptero en estacionario). Los valores por defecto del motor (tabla HLR-STCA-01) siguen siendo el fallback certificado. La separación vertical de Ruta se fija en **800 ft** (bajo el mínimo RVSM de 1000 ft) por diseño: con umbral igual a 1000 ft, el tráfico **correctamente separado** a 1000 ft en RVSM dispararía STCA ante el ruido de altimetría (falsas alarmas sistemáticas); 800 ft deja margen bajo el mínimo para alertar **solo ante una pérdida real** de separación. *(Justificación operacional del responsable, 2026-07-09.)*
